...
## Overview
Applies various optimizations to C&amp;C Renegade Mix and Pkg files to improve performance in-game and reduce size. Supports both Windows and Linux.
...
- `--ffmpeg-location`: Path which contains the 'ffmpeg' binary. If not specified and not found in the system, MixOptimize will attempt to download it.
...
#### Skipping sounds
`mixoptimize --skip-sounds "C&C_Cool_Mod.pkg"`
